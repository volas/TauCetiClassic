...
/client/proc/cmd_admin_change_custom_event()
	...
	var/input = sanitize(input(usr, "Enter the description of the custom event. Be descriptive. To cancel the event, make this blank or hit cancel.", "Custom Event", reset_ja(custom_event_msg)) as message|null, list("ÿ"=LETTER_255))
	if(!input || input == "")
