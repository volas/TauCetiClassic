...
/datum/outfit/job/teammate // todo: refresh, spawner
	name = OUTFIT_JOB_NAME("Teammate")
	//flag = ENGINEER
...
/datum/outfit/job/teammate/equip(mob/living/carbon/human/H, visualsOnly = FALSE)
	if(!H)	return 0
	switch(H.backbag)
