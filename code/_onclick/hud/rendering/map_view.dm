...
/atom/movable/screen/map_view/atom_init(mapload, map_view, background_state = "clear", add_planes = global.all_plane_masters)
	...
	background.screen_loc = "[map_view]:[screen_loc]"
...
/atom/movable/screen/map_view/update_size(x, y)
	cam_background.screen_loc = "1,1 to [x],[y]"

/atom/movable/screen/map_view/set_background(background_state)
	cam_background.icon_state = background_state

/atom/movable/screen/map_view/show_to(client/client)
	client.screen += background
	client.screen += src

/atom/movable/screen/map_view/hide_from(client/client)
	client.screen -= background
	client.screen -= src
