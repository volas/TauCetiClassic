...
//ja problem
#define JA_CHARACTER        "я"
#define JA_UPPERCHARACTER   "Я"
...
#define TRAIT_TOURETTE \
	list("ГОВНО", "ЖОПА", "ЕБАЛ", "ПИДАРА-АС", "ХУЕСОС", "СУКА", "МАТЬ ТВОЮ","А НУ ИДИ СЮДА","УРОД")
#define CYRILLIC_AHELPCLICKNAME \
	"Нажмите на им[JA_PLACEHOLDER] администратора дл[JA_PLACEHOLDER] ответа."
